...
> **⚠️ УСТАРЕЛО · сверено 2026-08-04.**
> Документ подан как описание текущего состояния, но расходится с рабочим стеком. Не использовать как справку, пока не обновлён.
> Конкретных расхождений найдено: **35** — перечислены в разборе.
