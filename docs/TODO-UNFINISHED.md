...
>
> `disruption` получил `semantic_cluster_max_posts: 2000`. Прогон: 673с против 54,
> кластеров 1636 против 323, покрытие 40.7% → 44.5% и растёт (backfill не нужен,
> окно скользящее). Добавлены `frontier_clustering_coverage_ratio` и два алерта
> на **регрессию** покрытия. Подробности —
> [маршрут, заход 3](./AUDIT-2026-08-04.md#7-маршрут).
