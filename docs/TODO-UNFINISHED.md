...
### 4. Весь алертинг ходит через admin: 135 из 296 доставок за 7 дней провалились, алерт про падение admin доставить невозможно
...
### 19. Месяц продовых правок живёт только в тэгах веток: main заморожен на 2026-07-03, 26 коммитов не влиты
...
### 20. В продовой рабочей копии лежит незакоммиченный код, который УЖЕ раскатан в образ
...
### 23. Токен вебхука Alertmanager ездит в query string и пишется открытым текстом в docker-логи admin; плюс fail-open при пустом значении
