...
Всего пунктов **73** (52 из аудита + 3 найдено при вечерней перепроверке
+ 2 найдено при построении маршрута II и его исполнении + **16 найдено при сверке
и раскате 06.08**).
...
| ⬜ **Открыто** | 28 | 6, 7, 27, 29, 31, 32, 33, 34, 35, 36, 38, 40, 42, 45, 46, 50, 51, 52, 54, 55, 57, 64, 65, 66, 67, 69, **72**, **73** |
