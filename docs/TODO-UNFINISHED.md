...
| | Пункты |
|---|---|
| ✅ **Сделано** — 14 | 1 кластеризация · 2 контур RSI · 4 алертинг · 5 восстановление · **15 свежесть аналитики** · 17 метрики бэкапа · 19 слияние в main · 20 незакоммиченный код · 21 профили compose · 23 токен вебхука · **30 снимок экспозиции** · **44 replay окна** · **56 шумящий алерт** |
| 🟡 **Частично** — 1 | **18 петля alert-triage** — сигнал живости поставлен, причина смерти не найдена |
| 🔒 **Отложено решением владельца** — 2 | 3 аутентификация шлюза 8102 · **22 внешняя экспозиция и файрвол** |
| ⬜ **Открыто** — 40 | остальные, включая новый 57 |
