...
| | Пункты |
|---|---|
| ✅ **Сделано** — 19 | 1 кластеризация · 2 контур RSI · 4 алертинг · 5 восстановление · **9 осиротевший стрим** · **13 счётчики стадий** · **14 метрики хранилищ** · 15 свежесть аналитики · 17 метрики бэкапа · 19 слияние в main · 20 незакоммиченный код · 21 профили compose · 23 токен вебхука · **24 RSI-метрики** · 30 снимок экспозиции · **39 потеря при тримминге** · 44 replay окна · 56 шумящий алерт |
