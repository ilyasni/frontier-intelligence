...
+ 2 найдено при построении маршрута II и его исполнении). Ещё 12 найдено
при сверке 06.08 — они ведутся в [AUDIT-2026-08-06.md, §3.5](./AUDIT-2026-08-06.md),
чтобы не размывать этот реестр.

| | Пункты |
|---|---|
| ✅ **Сделано** — 23 | 1 кластеризация · 2 контур RSI · 4 алертинг · 5 восстановление · 9 осиротевший стрим · 11 скоуп воркспейса · 13 счётчики стадий · 14 метрики хранилищ · 15 свежесть аналитики · 19 слияние в main · 20 незакоммиченный код · 21 профили compose · 23 токен вебхука · 24 RSI-метрики · **26 «не измерено»** · **28 дедуп ре-синдикации** · 30 снимок экспозиции · 37 призрачные консьюмеры · 39 потеря при тримминге · 41 синтез · 44 replay окна · 47 мосты воркспейсов · 56 шумящий алерт |
| 🟡 **Частично** — 8 | 8 исходы краула · **10 auto_hmi** (5 источников из 10, 54 поста, трендов ноль) · 12 DLQ · 18 петля alert-triage · 25 провенанс · **48 раскат батчей** (включено 16 из 27) · **49 email-коннектор** (код доделан, источника в БД нет) · 53 crawl4ai |
| 🔒 **Отложено решением владельца** — 2 | 3 аутентификация шлюза 8102 · 22 внешняя экспозиция и файрвол |
| ♻️ **Откатилось и исправлено 06.08** — 1 | **17 метрики бэкапа и квоты S3** — метрика была зажата в INT32_MAX, оба квотных алерта недостижимы; починено и проверено на сервере |
| ⬜ **Открыто** — 23 | 6, 7, 16, 27, 29, 31, 32, 33, 34, 35, 36, 38, 40, 42, 43, 45, 46, 50, 51, 52, 54, 55, 57 |
