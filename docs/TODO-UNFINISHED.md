...
Всего пунктов **56** (52 из аудита + 3 найдено при вечерней перепроверке
+ 1 найден при построении маршрута II).
...
| ⬜ **Открыто** — 46 | остальные, включая новый 56 |
...
### 56. Алерт `FrontierOpenRouterModelQuarantineBurst` шумит каждый день на штатном поведении

> Найден 2026-08-04 при построении маршрута II. В исходном аудите отсутствовал —
> утром правило не было firing.
