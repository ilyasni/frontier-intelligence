...
## Состояние на 2026-08-04, ночь

Всего пунктов **57** (52 из аудита + 3 найдено при вечерней перепроверке
+ 2 найдено при построении маршрута II и его исполнении).

| | Пункты |
|---|---|
| ✅ **Сделано** — 24 | 1 кластеризация · 2 контур RSI · 4 алертинг · 5 восстановление · 9 осиротевший стрим · **11 скоуп воркспейса** · 13 счётчики стадий · 14 метрики хранилищ · 15 свежесть аналитики · 17 метрики бэкапа · 19 слияние в main · 20 незакоммиченный код · 21 профили compose · 23 токен вебхука · 24 RSI-метрики · 30 снимок экспозиции · **37 призрачные консьюмеры** · 39 потеря при тримминге · **41 синтез** · 44 replay окна · **47 мосты воркспейсов** · **49 email-коннектор** · 56 шумящий алерт |
| 🟡 **Частично** — 4 | 18 петля alert-triage · 12 DLQ · **8 исходы краула** (видимы, но нет записи в БД и ретрая) · **53 crawl4ai** (призраки вылечены, healthcheck и причина падений нет) |
| 🔒 **Отложено решением владельца** — 2 | 3 аутентификация шлюза 8102 · 22 внешняя экспозиция и файрвол |
| ⬜ **Открыто** — 27 | остальные |

**Заходы 7, 8 и 9 маршрута II выполнены**, заход 10 выполнен частично
(11 и 41 закрыты, 16 и хвосты остались). Плюс вне маршрута закрыты пункты
47 и 49 решением владельца от 2026-08-05, а пункт 29 отложен им же
до следующей сессии.

**Что осталось по маршруту:**

| Заход | Осталось |
|---|---|
| 10 | 16 (телеметрия MCP-инструментов, `/metrics` у шлюза), хвосты 32/46/52 (сужение контракта), self-scrape Prometheus из 43 |
| 11 | 10, 48, 38 — раскат источников волнами. **По построению многодневный**: один батч в сутки с наблюдением между волнами, плюс гейт на длительность кластеризации |
| 12 | 26, 25, 28 — провенанс и дедуп |
...
### 18. 🟡 ЧАСТИЧНО 2026-08-04 — сигнал живости поставлен, причина смерти не найдена
...
### 49. ✅ СДЕЛАНО 2026-08-05 — ~~email-коннектор не исполнялся ни разу~~
